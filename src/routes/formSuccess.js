	...
	return (
		<div class="mt-10 text-center">
			...
			<p class="mt-5">
				...
				Non dimenticare di condividere con i tuoi amici quest'app per fare in modo che tutte le piccole attività e non, nel comune di Casapesenna, siano presenti!
			</p>
